class UserMessages:
    ...
    add_youtube_mes = "Отправь мне ссылку на нужный youtube калан в формате https://www.youtube.com/name"
    ...
    no_news_mes = 'В интересующих вас источниках не появилось новой информации за это время'
    ...
    plan_mes = "Напиши когда ты хочешь выложить этот пост в формате ЧАС:МИНУТА ДЕНЬ:МЕСЯЦ:ГОД. Например, если ты " \
               "хочешь выложить пост в 12.35 11 мая 2023, то отправь мне 12:35 11:05:2023"
